...
Output: NPDatabase with substructure and structure_has_substructure tables
...
def create_substructure_data(molblocks_results):
    ...
    molblocks_results: output from molblocks with substructures and structure id
    """
...
def store_substructure_table_data(substructure_table_data, NPDatabase_path):
    ...
    print ('Substructure table created and new substructure are added')
    # Add data to table
...
def store_structure_has_substructure_table_data(combo_list, NPDatabase_path):
    ...
    print ('Structure_has_substructure table created and data added')
    # Commit your changes
    conn.commit()
